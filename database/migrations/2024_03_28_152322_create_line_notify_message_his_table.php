...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('line_notify_message_his', function (Blueprint $table) {
            $table->integer('id')->primary();
            $table->string('msg_id', 32);
            ...
            $table->dateTime('arch_at')->nullable()->useCurrent();
    ...
    {
        Schema::dropIfExists('line_notify_message_his');
    }
};
