<!DOCTYPE html><html><head><meta charset="UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, viewport-fit=cover, user-scalable=no"><title>Chatbot 台灣開發者</title><meta name="description" content="「Chatbot Developers Taiwan」的名片"><meta property="og:description" content="「Chatbot Developers Taiwan」的名片"><meta property="og:title" content="Chatbot 台灣開發者"><meta property="og:type" content="website"><meta property="og:image:height" content="640"><meta property="og:image:width" content="1280"><meta property="og:image" content="https://i.imgur.com/lEKHcUY.png"><meta property="og:url" content="https://cc.fruit/forms/chatbot-tw-1.html"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4/dist/css/bootstrap.min.css"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/font-awesome@4/css/font-awesome.min.css"><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Noto+Sans+TC:wght@400;700&amp;display=swap"><style>[v-cloak] {
  display: none;
}
...
@endverbatim</script><script>window.vueConfig.data.vcard = {
  name: '小美',
  template: 'https://cc.fruit/cards/chatbot-tw-1.txt',
  title: '小萌新',
