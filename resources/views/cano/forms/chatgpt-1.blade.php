<!DOCTYPE html><html><head><meta charset="UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, viewport-fit=cover, user-scalable=no"><title>ChatGPT 問與答</title><meta name="description" content="讓你在 LINE 中模擬 ChatGPT 的問答畫面！上面有開啟自訂連結及再次分享的按鈕。"><meta property="og:description" content="讓你在 LINE 中模擬 ChatGPT 的問答畫面！上面有開啟自訂連結及再次分享的按鈕。"><meta property="og:title" content="ChatGPT 問與答"><meta property="og:type" content="website"><meta property="og:image:height" content="640"><meta property="og:image:width" content="1280"><meta property="og:image" content="https://i.imgur.com/0uU5aCG.png"><meta property="og:url" content="https://cc.fruit/forms/chatgpt-1.html"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4/dist/css/bootstrap.min.css"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/font-awesome@4/css/font-awesome.min.css"><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Noto+Sans+TC:wght@400;700&amp;display=swap"><style>[v-cloak] {
  display: none;
}
...
_.set(cfg, 'data.vcard', {
  ...
  template: 'https://cc.fruit/cards/chatgpt-1.txt',
})
cfg.computed = {
  ...cfg.computed,
  shortcut () {
    ...
    if (!_.isString(params) || !params.length) return
    return `https://liff.line.me/1661414135-95aMGZzm/share-json5gzip.html?${params}`
  },
