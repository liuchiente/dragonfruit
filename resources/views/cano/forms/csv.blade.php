<!DOCTYPE html><html><head><meta charset="UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, viewport-fit=cover, user-scalable=no"><title>LINE 數位版名片 (CSV)</title><meta name="description" content="從 CSV 讀取名片資料來產生名片"><meta property="og:description" content="從 CSV 讀取名片資料來產生名片"><meta property="og:title" content="LINE 數位版名片 (CSV)"><meta property="og:type" content="website"><meta property="og:image:height" content="640"><meta property="og:image:width" content="1280"><meta property="og:image" content="https://i.imgur.com/CU3myIc.png"><meta property="og:url" content="https://cc.fruit/forms/csv.html"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4/dist/css/bootstrap.min.css"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/font-awesome@4/css/font-awesome.min.css"><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Noto+Sans+TC:wght@400;700&amp;display=swap"><style>[v-cloak] {
  display: none;
}
...
cfg.computed.shortcut = function () {
  const params = window.httpBuildQuery(_.mapValues(this.vcard, window.encodeBase64url))
  if (!_.isString(params) || !params.length) return
  return `https://liff.line.me/1661414135-95aMGZzm/share-csv.html?${params}`
}
cfg.data.vcard = {
  template: 'https://cc.fruit/cards/chatbot-tw-coscup-2020.txt',
  csv: 'https://cc.fruit/csv/chatbot-tw-coscup-2020.csv',
  key: 'id',
  value: '1',
