<!DOCTYPE html><html><head><meta charset="UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, viewport-fit=cover, user-scalable=no"><title>Facebook Post Link</title><meta name="description" content="讓你在 LINE 中模擬 Facebook 分享連結，並且還可再次分享！"><meta property="og:description" content="讓你在 LINE 中模擬 Facebook 分享連結，並且還可再次分享！"><meta property="og:title" content="Facebook Post Link"><meta property="og:type" content="website"><meta property="og:image:height" content="640"><meta property="og:image:width" content="1280"><meta property="og:image" content="https://i.imgur.com/hO0LAHK.png"><meta property="og:url" content="https://cc.fruit/forms/facebook-post-link-1.html"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4/dist/css/bootstrap.min.css"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/font-awesome@4/css/font-awesome.min.css"><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Noto+Sans+TC:wght@400;700&amp;display=swap"><style>[v-cloak] {
  display: none;
}
...
@endverbatim</script><script>window.vueConfig.data.vcard = {
  action: '分享了 1 個連結。',
  altText: '王小明分享了 1 個連結。',
  author: '王小明',
  avatar: 'https://i.imgur.com/ceV22WT.png',
  desc: '從 CSV 讀取名片資料來產生名片',
  image: 'https://i.imgur.com/CU3myIc.png',
  link: 'https://taichunmin.idv.tw/liff-businesscard/forms/csv.html',
  ratio: '1280:640',
  template: 'https://cc.fruit/cards/facebook-post-link-1.txt',
  title: '從 CSV 讀取名片資料來產生名片',
  website: 'https://taichunmin.idv.tw/',
