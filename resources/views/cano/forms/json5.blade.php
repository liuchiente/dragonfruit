<!DOCTYPE html><html><head><meta charset="UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, viewport-fit=cover, user-scalable=no"><title>LINE 數位版名片 (JSON5)</title><meta name="description" content="提供給有程式背景的開發者使用，可以使用 JSON5 API 來當作樣版的資料來源。"><meta property="og:description" content="提供給有程式背景的開發者使用，可以使用 JSON5 API 來當作樣版的資料來源。"><meta property="og:title" content="LINE 數位版名片 (JSON5)"><meta property="og:type" content="website"><meta property="og:image:height" content="640"><meta property="og:image:width" content="1280"><meta property="og:image" content="https://i.imgur.com/ci4T6xG.png"><meta property="og:url" content="https://cc.fruit/forms/json5.html"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4/dist/css/bootstrap.min.css"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/font-awesome@4/css/font-awesome.min.css"><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Noto+Sans+TC:wght@400;700&amp;display=swap"><style>[v-cloak] {
  display: none;
}
...
cfg.computed.shortcut = function () {
  const params = window.httpBuildQuery(_.mapValues(this.vcard, window.encodeBase64url))
  if (!_.isString(params) || !params.length) return
  return `https://liff.line.me/1661414135-95aMGZzm/share-json5.html?${params}`
}
cfg.data.vcard = {
  template: 'https://cc.fruit/cards/line-carousel-1.txt',
  json5: 'https://cc.fruit/json5/line-carousel-1.json5',
