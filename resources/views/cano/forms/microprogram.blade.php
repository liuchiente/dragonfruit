<!DOCTYPE html><html><head><meta charset="UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, viewport-fit=cover, user-scalable=no"><title>微程式資訊 LINE 名片</title><meta name="description" content="微程式資訊的名片範例。"><meta property="og:description" content="微程式資訊的名片範例。"><meta property="og:title" content="微程式資訊 LINE 名片"><meta property="og:type" content="website"><meta property="og:image:height" content="640"><meta property="og:image:width" content="1280"><meta property="og:image" content="https://i.imgur.com/NXiylpJ.png"><meta property="og:url" content="https://cc.fruit/forms/microprogram.html"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4/dist/css/bootstrap.min.css"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/font-awesome@4/css/font-awesome.min.css"><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Noto+Sans+TC:wght@400;700&amp;display=swap"><style>[v-cloak] {
  display: none;
}
...
@endverbatim</script><script>window.vueConfig.data.vcard = {
  ...
  name_en: 'Mei Wang',
  name_tw: '王小美',
  template: 'https://gist.githubusercontent.com/taichunmin/4c3931a5ef5168b8ddab341c770b151e/raw/microprogram-default.txt',
  title_en: 'Marketing',
  title_tw: '行銷企劃',
