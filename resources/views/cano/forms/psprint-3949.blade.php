...
<html>
   <head>
      ...
      <title>PsPrint Right Align One</title>
      <meta name="description" content="來自 PsPrint 的樣板，上面有連結可以開啟，很適合用來製作個人名片！">
      <meta property="og:description" content="來自 PsPrint 的樣板，上面有連結可以開啟，很適合用來製作個人名片！">
      <meta property="og:title" content="PsPrint Right Align One">
      <meta property="og:type" content="website">
      <meta property="og:image:height" content="640">
      <meta property="og:image:width" content="1280">
      <meta property="og:image" content="https://i.imgur.com/tUvhifE.png">
      <meta property="og:url" content="https://cc.fruit/forms/psprint-3949.html">
   ...
   <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
         <a class="navbar-brand mb-0 h1" href="https://cc.fruit/">LINE 數位版名片</a><button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#businesscard-navbar"><span class="navbar-toggler-icon"></span></button>
         <div class="collapse navbar-collapse" id="businesscard-navbar">
            <ul class="navbar-nav mr-auto">
               <li class="nav-item"><a class="nav-link" href="https://cc.fruit/"><i class="fa fa-fw fa-list"></i> 首頁</a></li>
               <li class="nav-item"><a class="nav-link" target="_blank" href="https://developers.line.biz/flex-simulator/"><i class="fa fa-fw fa-eye"></i> Flex 訊息模擬器</a></li>
            </ul>
         </div>
      </nav>
      <div class="container my-4" id="app" v-cloak>
         <h2 class="my-3 text-center">PsPrint Right Align One</h2>
         <div class="form-group was-validated my-2"><label for="vcard-logo">LOGO</label><input class="form-control form-control-sm" id="vcard-logo" type="url" inputmode="url" required pattern="https://\S+" v-model.trim="vcard.logo"><small class="form-text text-muted">請填寫 LOGO 圖片網址，必須是 <code>https://</code> 開頭，比例為 <code>1:1</code>，建議可將圖片<a target="_blank" href="https://imgur.com/">上傳到 Imgur 圖床</a>。</small></div>
         <div class="form-group was-validated my-2"><label for="vcard-name">姓名</label><input class="form-control form-control-sm" id="vcard-name" type="text" required pattern=".+" v-model="vcard.name"><small class="form-text text-muted">請填寫姓名。</small></div>
         <div class="form-group was-validated my-2"><label for="vcard-title">職稱</label><input class="form-control form-control-sm" id="vcard-title" type="text" required pattern=".+" v-model="vcard.title"><small class="form-text text-muted">請填寫職稱。</small></div>
         <div class="form-group was-validated my-2"><label for="vcard-company">公司</label><input class="form-control form-control-sm" id="vcard-company" type="text" required pattern=".+" v-model="vcard.company"><small class="form-text text-muted">請填寫公司名稱。</small></div>
         <div class="form-group was-validated my-2"><label for="vcard-address">地址</label><input class="form-control form-control-sm" id="vcard-address" type="text" required pattern=".+" v-model="vcard.address"><small class="form-text text-muted">請填寫公司地址。</small></div>
         <div class="form-group was-validated my-2"><label for="vcard-maps">地圖</label><textarea class="form-control form-control-sm" id="vcard-maps" inputmode="url" required pattern="https?://\S+" v-model="vcard.maps" rows="3"></textarea><small class="form-text text-muted">請填寫公司的 Google 地圖網址。</small></div>
         <div class="form-group was-validated my-2"><label for="vcard-tel">電話</label><input class="form-control form-control-sm" id="vcard-tel" type="tel" inputmode="tel" required pattern="[0-9,+-]+" v-model="vcard.tel"><small class="form-text text-muted">請填寫公司電話。</small></div>
         <div class="form-group was-validated my-2"><label for="vcard-email">信箱</label><input class="form-control form-control-sm" id="vcard-email" type="email" inputmode="email" required pattern=".+" v-model="vcard.email"><small class="form-text text-muted">請填寫公司信箱。</small></div>
         <div class="form-group was-validated my-2"><label for="vcard-url">網站</label><input class="form-control form-control-sm" id="vcard-url" type="url" inputmode="url" required pattern="(https?://|line://|tel:|mailto:)\S+" v-model.trim="vcard.url"><small class="form-text text-muted">請填寫公司網站。</small></div>
         <div class="row mx-n2 my-2 d-flex"><button class="btn btn-danger flex-fill mx-2 my-1" type="button" @click="btnReset"><i class="fa mr-2 fa-repeat"></i> 重設表單</button><button class="btn btn-info flex-fill mx-2 my-1" type="button" @click="btnExport"><i class="fa mr-2 fa-code"></i> 匯出匯入</button><a class="btn btn-primary flex-fill mx-2 my-1" :href="shortcut" target="_blank"><i class="fa mr-2 fa-id-card-o"></i> 建立名片</a></div>
      ...
      <script src="{{ asset('/js/common.js') }}"></script></script><script>@verbatim
         ...
         @endverbatim
      </script><script>window.vueConfig.data.vcard = {
         address: '台中市西屯區市政路402號7樓',
         company: '微程式資訊股份有限公司',
         ...
         name: '王小美',
         tel: '04-23692699,000',
         template: 'https://cc.fruit/cards/psprint-3949.txt',
         title: '行銷企劃',
         url: 'https://www.program.com.tw',
         }
